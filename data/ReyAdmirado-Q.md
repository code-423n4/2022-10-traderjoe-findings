...
| 10 | [Division by 0 might occur](#) |
| 11 | [Code Style: constant should be named in all caps](#) |
...
`_balance` should be checked
- [LBRouter.sol#891](https://github.com/code-423n4/2022-10-traderjoe/blob/main/src/LBRouter.sol#891)
- [LBRouter.sol#896](https://github.com/code-423n4/2022-10-traderjoe/blob/main/src/LBRouter.sol#896)

`_totalSupply` should be checked
- [FeeDistributionHelper.sol#L](https://github.com/code-423n4/2022-10-traderjoe/blob/main/src/libraries/FeeDistributionHelper.sol#L)
